...
hl.monitor({ output = "DP-1", mode = "2560x1440@239.74", position = "0x0", scale = 1 })
...
hl.bind("SUPER + SHIFT + C", hl.dsp.exec_cmd("discord-canary"))
...
hl.bind("SUPER + H", hl.dsp.exec_cmd("~/.config/hypr/scripts/toggle-hdr.sh"))
